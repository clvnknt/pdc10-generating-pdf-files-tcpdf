...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // set bacground image
        $img_file = K_PATH_IMAGES.'ash-greninja.jpg';
...
Complete Name: Calvin Kent R. Pamandanan<br>
Program: CCS<br>
Email: pamandanan.calvinkent@auf.edu.ph<br>
Address: Hacienda, Pandacaqui, Mexico, Pampanga<br>
Student Number: 14-0155-965</p>';
